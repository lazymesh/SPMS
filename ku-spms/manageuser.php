...
elseif ($action == "resetpassword")
{
	...
	try{
		...
		$notice->send_mail($email,$subject,$text, $name);
		}
	catch(manageuserException $e){}
...
} elseif ($action == "edit")
{
    ...
    if (!empty($_FILES['userfile']['name']))
    {
		...
		try{
		$subject="password updated";
		$text= "administrator has created new password for you, which is: ".$newpass;
		$notice->send_mail($email,$subject,$text, $name);
		}
 		catch(manageuserException $e){}
            }
    ...
    else
    {
		...
		try{
		$subject="password updated";
		$text= "you have successfully changed your password, your new password is: ".$newpass;
		$notice->send_mail($email,$subject,$text, $name);
		}
		catch(manageuserException $e){}
            }
