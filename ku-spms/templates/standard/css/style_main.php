...
$grdsMain = "#65635e";
$grdsB = "#a3a19e"; // Borders in Forms
$grdsC = "#464440"; // Buttons Hover
$grdsBlockhead = "url(../images/tables-msgs-head.png)";
$grdsTablehead = "url(../images/tables-msgs-thead.png)";
$grdsTableSecondhead = "url(../images/tables-msgs-sechead.png)"; // closed Things
$grdsColorA = "url(../images/tables-msgs-bg-a.png)"; // ColorMix Rows
$grdsColorB = "url(../images/tables-msgs-bg-b.png)"; // ColorMix Rows
$grdsColorC = "url(../images/tables-msgs-bg-c.png)"; // Files in Messages
...
body {
	color:#082343;
	background:#801000 url(../images/color-c-cyan.jpg) repeat-x 0 0;
...
#header-wrapper {
	width:100%;
	height: 70px;
	background:#801000 url(../images/color-c-cyan.jpg) repeat 0 0;
}
...
.statuswrapper a.grade, .statuswrapper a.grade-active {
	width: 12px;
    background: url(../images/butn-grade.png) no-repeat center 4px;
}
...
.statuswrapper a:hover, .statuswrapper a.closed, .statuswrapper a.edit-active, .statuswrapper a.grade-active, .statuswrapper a.reply-active .statuswrapper a.grade-active{
...
.grds .headline, .grds a.butn_link, .grds button, .grds a.butn_link_active:hover, .grds .inmenue a span, .grds .moreinfo, .grds .inmenue a span, .grds .moreinfo {
	background: <?php echo $grdsBlockhead;
?>;
}

.grds thead {
	background: <?php echo $grdsTablehead;
?>;
}

.grds .second-thead, .grds .second-thead:hover td, .grds .block_in_wrapper, .grds .inwrapper li:hover, .grds .statuswrapper li.link:hover {
	background: <?php echo $grdsTableSecondhead;
?>;
}

.grds .color-a, .grds .statuswrapper li {
	background: <?php echo $grdsColorA;
?>;
}

.grds .color-b {
	background: <?php echo $grdsColorB;
?>;
}

.grds .color-a ul.files table, .grds .color-b ul.files table {
	background: <?php echo $grdsColorC;
?>;
}

.grds, .grds .block, .grds a, .grds h1, .grds .block .tablemenue, .grds .block .addmenue, .grds p.tags-miles {
	border-color: <?php echo $grdsMain;
?>;
	color: <?php echo $grdsMain;
?>;
}

.grds h1 span, .grds h1 span a, .grds .block_in_wrapper h2 {
	color: <?php echo $grdsB;
?>;
}
...
.grds form, .grds form input, .grds form select, .grds form textarea, .grds form .row .editor, .grds .statuswrapper li {
	border-color: <?php echo $grdsB;
?>;
	color: <?php echo $grdsMain;
?>;
}

.grds a.butn_link:hover, .grds button:hover, .grds button.inner-active, .grds form .fileinput:hover button, .grds a.butn_link_active {
	background: <?php echo $grdsC;
?>;
}
