<?php /* Smarty version 2.6.19, created on 1980-01-03 20:34:14
...
"/></td>
				...
				<tbody class="color-b">
					<tr>
						<td><label for = "company">Faculty:</label></td>
						<td class="right">
							<input type = "text" name = "company" id = "company" value = "<?php echo $this->_tpl_vars['user']['faculty']; ?>
" />
						</td>
					</tr>
				</tbody>
