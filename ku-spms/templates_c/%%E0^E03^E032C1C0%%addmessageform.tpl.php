<?php /* Smarty version 2.6.19, created on 2011-10-17 08:07:40
...
:</label>
				<button class="inner" onclick="blindtoggle('files-add');toggleClass(this,'inner-active','inner');return false;" onfocus="this.blur()"><?php echo $this->_config[0]['vars']['attachbutton']; ?>
</button>
