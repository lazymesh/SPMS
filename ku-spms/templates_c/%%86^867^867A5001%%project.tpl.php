<?php /* Smarty version 2.6.19, created on 2011-10-17 08:02:39
...
"></a></li>
               <?php if ($this->_tpl_vars['userpermissions']['projects']['close']): ?>
                <li class="link"><a class="grade" href="javascript:void(0);"  id="edit_butn" onclick="blindtoggle('form_grade');toggleClass(this,'grade-active','grade');;toggleClass('sm_project','smooth','nosmooth');toggleClass('sm_project_desc','smooth','nosmooth')" title="Add grade"></a></li>
				<?php endif; ?>
                <?php endif; ?>
...
unset($_smarty_tpl_vars);
 ?>
            	...
            	<div id = "form_grade" class="addmenue" style = "display:none;clear:both;">
					<div class="content-spacer"></div>
					<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "addgradeform.tpl", 'smarty_include_vars' => array('showhtml' => 'no')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
				</div>
