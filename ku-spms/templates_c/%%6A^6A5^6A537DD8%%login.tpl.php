<?php /* Smarty version 2.6.19, created on 2011-10-17 08:00:58
...
unset($_smarty_tpl_vars);
 ?>
		...
		<div class="login">
			<div class="login-in">
				<div class="logo-name">
					<h1><a href = "http://www.ku.edu.np/" title = "<?php echo $this->_tpl_vars['settings']['name']; ?>
 Open Source project management"><img src="./templates/standard/images/logo-a1.png" alt="<?php echo $this->_tpl_vars['settings']['name']; ?>
"  /></a></h1>
